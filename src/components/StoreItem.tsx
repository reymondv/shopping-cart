...
const StoreItem = ({ id, name, price, imgUrl }: StoreItemProps) => {
  ...
  return (
    <div className='container rounded-lg bg-gray-100 border-solid border-black border border-opacity-10 px-4 py-4 shadow-md'>
      <img
        src={imgUrl}
        alt={name}
        className='object-cover sm:w-[60vw] w-[70vw]'
      />
            ...
            <div className='flex flex-col'>
              <div className='flex justify-between items-center px-24'>
                ...
                <input
                  type='number'
                  min='0'
                  className='border border-black w-10 h-8 mt-3 text-center border-opacity-20 shadow-md'
              ...
              <div className='mt-6 mx-auto flex justify-between container'>
                <button
                  className='text-gray-500 font-semibold px-2 py-1 bg-gray-300 rounded-xl w-20 hover:shadow-md hover:bg-gray-400'
                  onClick={handleCartClick}>
                  Cancel
                </button>
                <button className='bg-blue-500 font-semibold px-2 py-1 text-white rounded-xl w-20 hover:shadow-md hover:bg-blue-900'>
                  Add
                </button>
              </div>
            </div>
